  ...
  <q-tab-panel name="package">
   ...
   <q-list>
    <q-item>
     ...
     <q-item-section avatar><q-icon color="primary" name="add_circle" @click="newPkgDlg=true"></q-icon></q-item-section>
    </q-item>
    <q-separator></q-separator>
    <q-item v-for="(p,n) in packages">
     <q-item-section>
	  <q-item-label>{{p.name}}</q-item-label>
	  <q-item-label caption>{{tags.pkgPrice}}:{{p.price}}, {{tags.pkgVal}}:{{p.val}}{{tags.unit.T}}</q-item-label>
     </q-item-section>
