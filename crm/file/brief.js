...
query_main() {
    ...
    request({method:"GET",url:url},this.service.name).then(function(resp){
        ...
        var series=[
            ...
            //{name:this.tags.report.payment,type:'line',data:payment,yAxisIndex:0},
            {name:this.tags.report.contract,type:'bar',data:contract,yAxisIndex:1},
            {name:this.tags.report.revenue,type:'bar',data:revenue,yAxisIndex:1},
            {name:this.tags.report.cost,type:'bar',data:cost,yAxisIndex:1}
        ];
